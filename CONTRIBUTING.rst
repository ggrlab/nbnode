...
Welcome to ``nbnode`` contributor's guide.
...
If you experience bugs or general issues with ``nbnode``, please have a look
...
You can help improve ``nbnode`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``nbnode`` documentation uses Sphinx_ as its main documentation compiler.
...
or Miniconda_::
    ...
    conda create -n nbnode python=3 six virtualenv pytest pytest-cov
    conda activate nbnode
...
#. Install |pre-commit|_::
   ...
   ``nbnode`` comes with a lot of hooks configured to automatically help the
