...
def gate_csv(
    ...
    Args:
        ...
        new_colnames (List[str]):
            vector of new colnames for the csvs. Usually used to make the colnames of the csvs
            matching to the celltree.
    ...
    Examples:
        ...
        ...         )
        >>> rescaled_data_dir_files = [os.path.join(rescaled_data_dir, file_x) for file_x in os.listdir(rescaled_data_dir)]
    ...
    # If the csv is a single file, it is of instance string, therefore encase it inside a list to
    # iterate over
